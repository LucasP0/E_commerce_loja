    ...
    <div className="containerHero grid grid-cols-ih p-6 mt-10">
      ...
      <div className="flex flex-row  items-baseline justify-center relative  ">
        <motion.div
          ...
          max-md:absolute max-md:w-[70%] max-md:h-full"></motion.div>
        <motion.img
          initial={{ bottom: "-2rem" }}
          whileInView={{ bottom: "0rem" }}
          transition={transition}
          className="w-[30rem] absolute bottom-0 max-md:w-[70%] h-full"
          src={HeroImg}
          alt=""
          width={600}
        />
        <motion.div
          ...
          initial={{ right: "4%" }}
          whileInView={{ right: "-5%" }}
          className="cart2 absolute bottom-[10%] right-[-5%] flex gap-4 text-center  max-sm:bottom-[-35%] max-lg:bottom-[0%] items-center">
