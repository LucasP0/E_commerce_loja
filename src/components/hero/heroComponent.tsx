  ...
  return (
    <div className="grid grid-cols-ih p-6 mt-10 max-md:grid-cols-1 max-md:place-items-center  max-md:gap-10 ">
      ...
      <div className="flex flex-row  items-baseline justify-center relative  ">
        <div className="w-[30rem] h-[30rem] rounded-[50%] -z-50 absolute bottom-0 bg-gradient-to-r from-[#0bb5ff] to-[#6dd3fe] max-md:relative max-md:h-[25rem] max-md:w-[25rem] max-sm:w-[15rem] max-sm:h-[15rem] "></div>
          <img 
            className="w-[30rem]
            ...
            width={600}
            />
          <div className="cart2 absolute bottom-[10%] right-[-5%] flex gap-4 text-center max-md:w-full max-md:justify-center max-md:bottom-[-20%] max-sm:bottom-[-35%] max-lg:bottom-[0%] items-center">
